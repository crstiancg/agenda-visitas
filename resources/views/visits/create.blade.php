...
@push('script')
    <script>
        ...
        document.querySelector("input[name='modal_dni']").addEventListener("keyup", function() {
        ...
        document.querySelector("input[name='modal_ruc']").addEventListener("keyup", function() {
            if(this.value = this.value.replace(/[^0-9]/g, "")){
        ...
        document.querySelector("input[name='modal_phone_number']").addEventListener("keyup", function() {
            if(this.value = this.value.replace(/[^0-9]/g, "")){
